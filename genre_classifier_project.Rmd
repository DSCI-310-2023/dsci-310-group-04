...
```{r song_data, echo = FALSE, message = FALSE}
...
```{r tidy_song_data, echo = FALSE, message = FALSE}
...
```{r training_song_data, echo = FALSE, message = FALSE}
...
```{r testing_song_data, echo = FALSE, message = FALSE}
...
```{r prop_df, echo = FALSE, message = FALSE}
# Preliminary data analysis
...
```{r num_na, echo = FALSE, message = FALSE}
...
```{r k_accuracy_table, echo = FALSE, message = FALSE}
